...
- __Application__ refers to BraneGuard, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BraneGuard.
...
- By email: support@braneguard.com
